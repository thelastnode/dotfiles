[smackpad]
as_sensitivity_rate = 4
as_initiate_key = <Super>v
...
as_put_top_key = <Super>Up
as_put_bottom_key = <Super>Down
...
s0_close_effects = animationaddon:Skewer;animation:Fade;animation:Fade;
...
[core]
as_active_plugins = core;ccp;resize;imgjpeg;workarounds;grid;text;gnomecompat;vpswitch;mousepoll;shift;svg;decoration;place;png;regex;obs;wobbly;resizeinfo;animation;loginout;fade;animationaddon;cube;rotate;move;3d;scale;scaleaddon;cubeaddon;scalefilter;expo;ezoom;staticswitcher;bench;
...
as_rotate_to_1_key = <Super>1
as_rotate_to_2_key = <Super>2
as_rotate_to_3_key = <Super>3
as_rotate_to_4_key = <Super>4
as_rotate_to_5_key = <Super>5
as_rotate_to_6_key = <Super>grave
...
as_run_command_terminal_key = <Alt>grave
...
as_switch_to_5_key = <Super>5
as_switch_to_6_key = <Super>grave
...
as_initiate_group_edge = TopRight
